...
class CascadeCli < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/JAManfredi/cascade-cli/releases/download/v0.1.151/ca-macos-arm64.tar.gz"
    sha256 "dba96038c2dfc65c0d527118f0f3f267c179a5ae92a0cb48c069a1bdf8033e2b"
    version "0.1.151"
  else
    # Intel (x64)
    url "https://github.com/JAManfredi/cascade-cli/releases/download/v0.1.151/ca-macos-x64.tar.gz"
    sha256 "4c0eb974f91d96718aa79a67c4264f0303b299f5b82e56b6362568b8a687d954"
    version "0.1.151"
  end
