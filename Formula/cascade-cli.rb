...
class CascadeCli < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/JAManfredi/cascade-cli/releases/download/v0.1.118/ca-macos-arm64.tar.gz"
    sha256 "5786a2aa96c521821ca51d149c2391f58114556b44f3b4db1ae647d8b64a1d34"
    version "0.1.118"
  else
    # Intel (x64)
    url "https://github.com/JAManfredi/cascade-cli/releases/download/v0.1.118/ca-macos-x64.tar.gz"
    sha256 "2ac2f6f9ce7deb3985c040ae09c158d515360a668cad700b8e98c812731f64a6"
    version "0.1.118"
  end
